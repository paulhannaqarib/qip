...
export default function RegionFilterDropdown({
    ...
    const label = value === "all" ? "All Regions" : value || "All Regions";
    ...
    return (
        <div className="relative" ref={ref}>
            ...
            >
                ...
                <span className="min-w-[140px] text-left">{label}</span>
                <ChevronDown size={16} className="text-slate-400" />
            </button>

            {open && (
                <div className="absolute left-0 top-12 z-50 w-[240px] rounded-xl border border-slate-200 bg-white shadow-[0_12px_30px_rgba(15,23,42,0.12)]">
                    <button
                        type="button"
                        onClick={() => {
                            onChange("all");
